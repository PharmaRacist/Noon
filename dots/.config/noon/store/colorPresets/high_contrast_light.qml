// HighContrastLight.qml
import QtQuick

QtObject {
    readonly property string name: "High Contrast Light"
    readonly property string description: "High contrast light theme for accessibility"
    ...
    readonly property var colors: ({
            ...
            "secondary": "#800080",
            "on_secondary": "#ffffff",
            "secondary_container": "#e6e6e6",
            "on_secondary_container": "#000000",
            "tertiary": "#008080",
            "on_tertiary": "#ffffff",
            "tertiary_container": "#e6e6e6",
            "on_tertiary_container": "#000000",
            "error": "#ff0000",
            "on_error": "#ffffff",
            "error_container": "#e6e6e6",
