...
Singleton {
    ...
    property var availableIconThemeNames: availableIconThemes.map(theme => theme.name)
    property var availableIconThemeIds: availableIconThemes.map(theme => theme.id)
