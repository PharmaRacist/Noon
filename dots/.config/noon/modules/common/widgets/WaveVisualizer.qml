...
Canvas { // Visualizer
    ...
    function drawThickBarVisualizer(ctx, w, h, n, maxVal) {
        ...
        for (var i = 0; i < n; ++i) {
            ...
            gradient.addColorStop(0.5, Qt.rgba(root.color.r, root.color.g, root.color.b, 1.0));
